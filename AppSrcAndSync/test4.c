...
int main(int argc, char *argv[])
{
	...
	pipeline = gst_parse_launch("gst-launch-1.0 rtspsrc port=8554 location=rtsp://127.0.0.1:8554/test ! rtpjitterbuffer name=buf ! application/x-rtp,payload=96 ! rtph264depay ! appsink name=mysink", NULL);
